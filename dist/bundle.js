...
React.render(
  React.createElement("div", null, 
        ...
        React.createElement(StockGrid, {stocks: stocks})
  ),
  document.getElementById('content')
);
},{"./StockData":149,"./components/MainMenu":150,"./components/StockGrid":152,"react":148}],2:[function(require,module,exports){
        ...
        return (
            React.createElement("div", null, 
                React.createElement("ul", null, 
                    React.createElement("li", null, React.createElement("a", null, "Menu 1")), 
                    React.createElement("li", null, React.createElement("a", null, "Menu 2")), 
                    React.createElement("li", null, React.createElement("a", null, "Menu 3"))
                )
                )
        );
    },
    ...
    render: function () {
        return (
             React.createElement("tr", null, 
                React.createElement("td", null, this.props.value.name), 
                React.createElement("td", null, "$", this.props.value.price)
            )
        );
    },
...
var StockGrid = React.createClass({displayName: "StockGrid",
    
    render: function () {
        var stocks = this.props.stocks.map(function (st) {
           return React.createElement(Stock, {value: st, key: st.id})
        }) 
        return (
            React.createElement("div", null, 
                React.createElement("h2", null, "Stocks"), 
